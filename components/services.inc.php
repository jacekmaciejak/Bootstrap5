        ...
        <div class="row align-items-center justify-content-center">
            <div class="
                ...
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                    Aliquid omnis provident, numquam sint nobis atque sed
                    cupiditate consequuntur quis ut.</p>
                <button type="button"
                    class="btn btn-light">Light</button>
            </div>
            <div class="col-md-6"><img src="img/coding.svg"
                    class="img-fluid"
                    alt="programming"></div>
            <div class="col-md-6"><img src="img/marketing.svg"
                    class="img-fluid"
                    alt="programming"></div>
            <div class="col-md-6">
                <h1>Lorem, ipsum.</h1>
